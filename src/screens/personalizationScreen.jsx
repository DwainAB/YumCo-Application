...
function Personalization(){
    ...
    return(
        <View style={[styles.containerPersonalization,{backgroundColor: colors.colorBackground}]}>
            <ScrollView>
                <View style={styles.containerScrollPersonalization}>
...
function useStyles(){
    ...
    return StyleSheet.create({
        ...
        containerTextDark:{
            ...
            flexDirection: "row",
            paddingLeft: 30,
            paddingBottom: (width > 375) ? 5 : 0,
            paddingTop:(width > 375) ? 5 : 0,
        },
        textDark:{
            color: "white",
            fontSize: (width > 375) ? 16 : 13,
        ...
        image: {
            width: (width > 375) ? 150 : 110,
            height: (width > 375) ? 150 : 110
        },
        containerScrollPersonalization:{
            marginBottom: 100
        }
    })
